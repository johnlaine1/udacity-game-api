...
from routes.games_routes import GamesEndpoints
from routes.users_routes import UsersEndpoints
from routes.scores_routes import ScoresEndpoints
...
#     """Hangman Game API"""
    ...
    #     """Create a user"""
    #     return users.create(request.user_name, request.email)
